...
public class ItemRemoveRecyclerView extends RecyclerView{
    ...
    //检测手指在滑动过程中的速度
    private VelocityTracker mVelocityTracker; //用于跟踪触摸事件的速度辅助，实现
    //投掷等动作。
    ...
    public boolean onTouchEvent(MotionEvent e) {
       ...
       // Log.e(TAG,"mDeleteBtnState"+mDeleteBtnState);
        int x = (int) e.getX();
        int y = (int) e.getY();
        switch (e.getAction()) {
...
//                            Toast.makeText(getContext(), "点击删除", Toast.LENGTH_SHORT).show();
                 ...
                 //   Log.e(TAG,"mDeleteBtnState==3   "+mDeleteBtnState);
